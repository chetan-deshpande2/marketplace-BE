...
const getCollectionDetailsByAddress = async (req, res) => {
  try {
    Collection.findOne(
      { sContractAddress: req.body.sContractAddress },
      (err, collection) => {
...
const userCollectionList = async (req, res) => {
  try {
...
const getCollectionNFT = async (req, res) => {
  try {
    let data = [];
...
const getCollectionNFTOwned = async (req, res) => {
  try {
    if (!req.userId) return res.send('unauthorized');
    let data = [];
    let collection = req.body.collection;
...
const updateCollectionToken = async (req, res) => {
